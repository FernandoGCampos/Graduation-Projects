// to compile: mpicc dist-mpi.c -o dist-mpi -lm -O3 -fopt-info-vec-optimized -ffast-math
// to run: mpirun -np <number_of_processes> dist-mpi <matrix_size> <random_seed>

// time mpirun -np 4 ./dist-mpi 100 1000
// time mpirun -np 4 ./dist-mpi 200 1
...
int main(int argc, char **argv) {
    ...
    int mat_size, rand_seed, total_size, size_per_processor, memory_shift, i, provided;
    ...
    if (argc != 3){
        printf("Wrong number of arguments. Please try again with mpirun -np <number_of_processes> dist-mpi <matrix_size> <random_seed> \n");
        fflush(0);
        exit(0);
    }
